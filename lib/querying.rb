...
def select_value_and_count_of_most_prolific_species
  "SELECT characters.species, COUNT(characters.species) AS c1 FROM characters GROUP BY characters.species ORDER BY c1 DESC LIMIT 1"
end
...
def select_series_title_with_most_human_characters
  ...
  JOIN books ON books.id=series.id
...
def select_character_names_and_number_of_books_they_are_in
  "SELECT characters.name, COUNT(*) as c1
